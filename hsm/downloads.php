	...
	<div class="row-fluid">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<ul>
				...
				<li><a href="./download.php?type=1DISC_graph">1DISC p-Value Graphs (.pdf) - by SNP</a></li>
				...
				<li><a href="./download.php?type=2FOLL_graph">2FOLL p-Value Graphs (.pdf) - by SNP</a></li>
